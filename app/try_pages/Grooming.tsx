...
const GROOMING_OPTIONS = [
  { id: '1', image: require('../try_pages/try_img/Groom_img/gr-1.jpg'), colors: ['#D2B48C', '#C19A6B', '#FF0000', '#FFD700', '#D81B8C', '#BF00FF'] },
  { id: '2', image: require('../try_pages/try_img/Groom_img/gr-2.jpg'), colors: ['#000000', '#FFFFFF', '#36454F', '#000080'] },
  { id: '3', image: require('../try_pages/try_img/Groom_img/gr-3.jpg'), colors: ['#F5F5DC', '#E1C16E', '#800000', '#006400'] },
  { id: '4', image: require('../try_pages/try_img/Groom_img/gr-4.jpg'), colors: ['#1A1A1A', '#4B0082', '#0000FF', '#FF4500'] },
  { id: '5', image: require('../try_pages/try_img/Groom_img/gr-5.jpg'), colors: ['#C0C0C0', '#B87333', '#40E0D0', '#FF69B4'] },
];
              ...
              <View className="flex-row items-center">
                ...
                {selectedOption?.colors.map((color, index) => (
                  <TouchableOpacity
                    ...
                    onPress={() => console.log("Grooming color applied:", color)}
                  />
                ))}
              </View>
            ) : (
