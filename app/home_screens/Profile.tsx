...
const Profile = () => {
  ...
  const menuItems = [
    ...
    { id: '2', title: 'Favourite', icon: <FavouriteIcon color={iconColor} />, path: '/home_screens/Favourites' },
    { id: '3', title: 'Appointments', icon: <AppointmentIcon color={iconColor} />, path: '/home_screens/Appointment' },
  ];
