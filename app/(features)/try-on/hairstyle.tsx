...
const HAIRSTYLE_OPTIONS = [
  { id: '1', image: require('../../../assets/images/try_img/Hairstyle_img/hr-1.jpg'), colors: ['#1A1A1A', '#3D3130', '#6B4C3E', '#A65E00', '#541A3F', '#B57914'] },
  { id: '2', image: require('../../../assets/images/try_img/Hairstyle_img/hr-2.jpg'), colors: ['#000000', '#2E1D16', '#4A3728', '#8C5423'] },
  { id: '3', image: require('../../../assets/images/try_img/Hairstyle_img/hr-3.jpg'), colors: ['#241C16', '#402E2A', '#734D3D', '#C98D5F', '#5C2B42'] },
  { id: '4', image: require('../../../assets/images/try_img/Hairstyle_img/hr-4.jpg'), colors: ['#121212', '#362822', '#634235', '#946333'] },
  { id: '5', image: require('../../../assets/images/try_img/Hairstyle_img/hr-5.jpg'), colors: ['#1C1C1C', '#4A3B33', '#825E4D', '#D49B6A'] },
];
