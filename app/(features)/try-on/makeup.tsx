...
const MAKEUP_OPTIONS = [
  { id: '1', image: require('../../../assets/images/try_img/Makeup_img/mk_2.jpg'), colors: ['#F9E4D9', '#E5B899', '#844E39', '#EDD1C4', '#D6A582'] },
  { id: '2', image: require('../../../assets/images/try_img/Makeup_img/mk_1.jpg'), colors: ['#F3D0C1', '#D4A387', '#72422E', '#EBC5B2', '#C69476'] },
  { id: '3', image: require('../../../assets/images/try_img/Makeup_img/mk_3.jpg'), colors: ['#FCEFE8', '#D8B199', '#965D46', '#F4DFD4', '#E0BC9E'] },
  { id: '4', image: require('../../../assets/images/try_img/Makeup_img/mk_4.jpg'), colors: ['#E9C6B5', '#B5846E', '#5E3023', '#DDB29F', '#A4745C'] },
  { id: '5', image: require('../../../assets/images/try_img/Makeup_img/mk_5.jpg'), colors: ['#FFF0E5', '#E9CBB7', '#AD7D66', '#F9E1D2', '#D9B49C'] },
];
