...
const MakeupNav = ({ activeTab, setActiveTab }: MakeupNavProps) => {
  ...
  return (
    <View className={`flex-row justify-around items-center ${bgColor} py-4 pb-8 border-t ${borderColor} shadow-sm rounded-t-[35px]`}>
      
      {/* 1. Makeup Tab */}
      <TouchableOpacity 
        className="items-center" 
        onPress={() => navigateTo('Makeup', '/try-on/makeup')}
      >
        <Palette 
      ...
      <TouchableOpacity 
        className="items-center" 
        onPress={() => navigateTo('Hairstyle', '/try-on/hairstyle')}
      >
        <Hairstyle 
      ...
      <TouchableOpacity 
        className="items-center" 
        onPress={() => navigateTo('Grooming', '/try-on/grooming')}
      >
        <Grooming 
